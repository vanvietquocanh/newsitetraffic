...
SortItems.prototype.renderReport = function() {
	...
	for(let x = 0; x < this.dataReportClick.length; x++){
		var elementHtml = `<tr role="row" class="odd fixcenter sel-items" style="color: #111">
							<td class="sorting_1" tabindex="0" style="color: #111">${sortItems.dataReportClick[x].id} / ${sortItems.dataReportClick[x].idOffer}</td>
							...
							<td class="showItems-name">${sortItems.dataReportClick[x].networkName}/${sortItems.dataReportClick[x].idOfferNet}</td>
